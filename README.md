...
<div align="center">
  ...
  <br><br>
  <h1 style="color: #ff00aa; text-shadow: 0 0 15px #ff00aa, 0 0 30px #ff00ff;">JAVA MAN ☕⚡️</h1>
  <h3 style="color: #00ffff; font-family: monospace;">"I don't write clean code. I write dirty, wet, overclocked code."</h3>
</div>

<br>

<div align="center" style="background: linear-gradient(135deg, #0f001a, #1a0033); padding: 25px; border: 2px dashed #ff00aa; border-radius: 14px; box-shadow: inset 0 0 50px #ff00ff22;">
